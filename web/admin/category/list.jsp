...
<table cellSpacing="1" cellPadding="0" width="100%" align="center" bgColor="#f5fafe" border="0">
    ...
    <tr>
        <td class="ta_01" align="center" bgColor="#f5f	afe">
            <table cellspacing="0" cellpadding="1" rules="all"
                ...
                <c:forEach items="${requestScope.categoryList}" var="cate" varStatus="z">
                    ...
                    <tr onmouseover="this.style.backgroundColor = 'white'"
                        ...
                        <td align="center" style="HEIGHT: 22px">
                            <a href="javascript:void(0)" onclick="deleteCategory('${cate.cid}')">
...
<script type="text/javascript">
   function deleteCategory(cid){
        if(confirm("确认删除吗?")){
            window.location.href="${pageContext.request.contextPath}/AdminCategoryServlet?method=deleteCategory&cid="+cid;
        }
    }
