...
public class _163EmailTest_2 {
    static String HOST = "smtp.163.com"; // smtp服务器
    static String FROM = "myheartpeng@163.com"; // 发件人地址
    static String USER = "myheartpeng@163.com"; // 用户名
    static String PWD = "zhouchao1010"; // 163的授权码
    static String SUBJECT = "激活码"; // 邮件标题
    static String[] TOS = new String[]{"2430879746@qq.com"};
    ...
    public static void main(String[] args) {
        send("aslkdfjalkdsjfal;kjdf;klasdj我喜欢你");
